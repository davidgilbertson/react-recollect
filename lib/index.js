...
var DEBUG = localStorage.getItem('RECOLLECT__DEBUG') || 'off'; // const PATH_PROP = Symbol('path'); // TODO (davidg): symbols mean I can't define the path as a string easily

var PATH_PROP = '__RR_PATH_PROP';
...
var proxyHandler = {
  get: function get(target, prop) {
    ...
    if (prop === PATH_PROP) return Reflect.get(target, prop); // TODO (davidg): think about this. Is 'constructor' a valid prop name? How can I avoid it?
